                            ...
                            <td class="px-4 py-3">
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center rounded-lg p-2 text-sm font-medium text-red-700 hover:bg-red-100 focus:outline-none focus:ring-4 focus:ring-red-300 dark:text-red-500 dark:hover:bg-gray-700 dark:focus:ring-red-800"
                                    >

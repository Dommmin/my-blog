...
'mail.mailers.smtp.local_domain','mail.mailers.smtp.scheme','mail.mailers.ses.transport','mail.mailers.postmark.transport','mail.mailers.resend.transport',
...
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','tinker.commands',
...
'two-factor.recovery-codes','terms.show','policy.show','profile.show',
'other-browser-sessions.destroy','current-user-photo.destroy','current-user.destroy','api-tokens.index','api-tokens.store',
'api-tokens.update','api-tokens.destroy','sanctum.csrf-cookie',
'home','post.show','comments.store','comments.update','comments.destroy',
'admin.home','admin.posts.index','admin.posts.create','admin.posts.store','admin.posts.show',
'admin.posts.edit','admin.posts.update','admin.posts.destroy','upload','storage.local',);
        registerArgumentsSet('views', 
'app','emails.team-invitation','errors.404','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'COMPOSE_PROJECT_NAME','APP_NAME','APP_ENV','APP_KEY','APP_DEBUG',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','OCTANE_SERVER',);
